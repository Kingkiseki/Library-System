      ...
      <div className="p-4 overflow-y-auto">
        {activities.length > 0 ? (
          activities.map((activity, index) => {
            const borrowerName = activity.student?.fullName || activity.teacher?.fullName || 'Unknown';
            const borrowerType = activity.borrowerType || (activity.student ? 'student' : 'teacher');
